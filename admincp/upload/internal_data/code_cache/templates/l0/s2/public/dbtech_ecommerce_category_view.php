<?php
// FROM HASH: 3be5f2fdcb8b5c480b8de6c1d62ce2c8
return array(
...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="dbtech_ecommerce_product" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	<div class="block-containe' . (($__templater->func('property', array('dbtechEcommerceProductListStyle', ), false) == 'grid') ? '--grid' : '') . '">
...
';
	$__templater->modifySideNavHtml('_xfWidgetPositionSideNav0795bfec141c3905ffe0cfc980f47749', $__templater->widgetPosition('dbtech_ecommerce_category_sidenav', array(
		'category' => $__vars['category'],
	)), 'replace');
