<?php
// FROM HASH: f0583bcffaaaa4273fe64d5e1c9e0ee2
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
			<a href="' . $__templater->func('link', array('dbtech-ecommerce/categories', $__vars['category'], ), true) . '" class="categoryList-link' . ($__vars['isSelected'] ? ' is-selected' : '') . '">
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="node node--depth2 node--productCategory node--productCategory' . $__templater->escape($__vars['category']['category_id']) . '">
		<div class="node-body">
	...
	$__finalCompiled .= '
				<h3 class="node-title">
					<a href="' . $__templater->func('link', array('dbtech-ecommerce/categories', $__vars['category'], ), true) . '" data-xf-init="' . (($__vars['descriptionDisplay'] == 'tooltip') ? 'element-tooltip' : '') . '" data-shortcut="node-description">' . $__templater->escape($__vars['category']['title']) . '</a>
				</h3>
				';
				...
				<div class="node-meta">
					<div class="node-statsMeta">
						<dl class="pairs pairs--inline">
							<dt>' . 'dbtech_ecommerce_products' . '</dt>
							<dd>' . $__templater->filter($__vars['extras']['product_count'], array(array('number', array()),), true) . '</dd>
						</dl>
					</div>
				</div>
	...
	if ($__vars['extras']['last_update']) {
		$__finalCompiled .= '
					<div class="node-extra-row"><a href="' . $__templater->func('link', array('dbtech-ecommerce', array('product_id' => $__vars['extras']['last_product_id'], 'title' => $__vars['extras']['last_product_title'], ), ), true) . '" class="node-extra-title" title="' . $__templater->escape($__vars['extras']['last_product_title']) . '">' . $__templater->escape($__vars['extras']['last_product_title']) . '</a></div>
