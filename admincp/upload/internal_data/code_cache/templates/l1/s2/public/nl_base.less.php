<?php
// FROM HASH: f591537e03827e33e0303dbc22d81159
return array(
...
// Makes up for page inner bottom padding
...
a.button // needed for specificity over a:link
{
	&.button--icon {
		...
		&--logout	    { .m-buttonIcon(@fa-var-sign-out, 1em); }
		&--register	    { .m-buttonIcon(@fa-var-sign-in, 1em); }
		&--signout	    { .m-buttonIcon(@fa-var-sign-out, 1em); }
		&--support	    { .m-buttonIcon(@fa-var-life-ring, 1em); }
		&--upgrade	    { .m-buttonIcon(@fa-var-rocket, 1em); }
	}
}
...
.p-navSticky.is-sticky {
	...
	&.p-navSticky--all .p-sectionLinks
	{
		position: relative;
		z-index: @zIndex-1;
		.xf-nlPublicSubNavSticky();
	}
}
...
.contentShadows {
	...
	.gridNodes.separateNodes.imgNodes.nodeImgAbove .node,
...
.blockStyle--flat .p-body {
	...
	[data-widget-definition="new_threads"] .message .message-cell {
		padding-left: 0;
		padding-right: 0;
	}
}
...
.columnContainer-sidebar {
	...
	// Enforce link types
	.listInline a:not(.u-concealed):not(.u-cloaked):first-of-type,
	.contentRow a:not(.u-concealed):not(.u-cloaked):first-of-type {
		font-size: inherit;
		.xf-nlSidebarLink();
	}
	.pairs > dt {
...
.structItem-status:before {
	color: @xf-nlStructItemStatusIconColor;
}
@media (max-width: @xf-responsiveMedium)
{
	.structItem-cell--inner {
