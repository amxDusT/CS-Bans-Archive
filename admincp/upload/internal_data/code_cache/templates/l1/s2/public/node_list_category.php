<?php
// FROM HASH: bacc5f9e38f8a0dc07c26bce3a5d0c6d
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__finalCompiled .= '
	<div class="block block--category block--category' . $__templater->escape($__vars['node']['node_id']) . ' block--nodes">
		...
		<div class="block-container block-container--category">
			<h2 class="block-header">
				...
				';
	if ($__vars['node']['description'] AND ($__templater->func('property', array('nlSeparateNodeDesc', ), false) == false)) {
		$__finalCompiled .= '<span class="block-desc">' . $__templater->filter($__vars['node']['description'], array(array('raw', array()),), true) . '</span>';
	}
	$__finalCompiled .= '
			</h2>
			';
	if ($__vars['node']['description'] AND $__templater->func('property', array('nlSeparateNodeDesc', ), false)) {
		$__finalCompiled .= '<span class="block-desc">' . $__templater->filter($__vars['node']['description'], array(array('raw', array()),), true) . '</span>';
	}
	$__finalCompiled .= '
