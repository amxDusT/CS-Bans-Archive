...
$database->query('SELECT `server_ip`, `name`, `auth`, `connect_time`, `numplayers`, `map`, `duration`, `flags`, `country`,`ip`  FROM `'.DB_TABLE_PA.'` WHERE auth = :auth AND '.getIpDatesSql().' ORDER BY `connect_time` DESC');
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div style="padding:10px">
									...
									<h4>Last IP</h4>
									<span class="badge-profile"><?php echo @$info[0]['ip']; ?></span>
								</div>
							</div><!-- /.panel-body -->
						</div><!-- /.panel -->
					</div><!-- /.col-lg-3 -->		
					<div class="col-lg-9">
							...
							<div class="panel-body">
								<div style="padding:10px">
									<table class="table table-hover table-bordered table-striped table-condensed" style="table-layout:fixed;width:100%;">
										<thead>
											<tr>
												<th style="text-align:left;width:13%;">Server </th>
												<th style="text-align:center;width:13%;">Date </th>
												<th style="text-align:center;width:10%;">Duration </th>
												<th style="text-align:center;width:3%;"><i class="fa fa-group fa-fw"> </i></th>
												<th style="text-align:right;">Map </th>
												<th style="text-align:right; width: 6%">Flags </th>
												<th style="text-align:right; width: 14%;">Name </th>
											</tr>
										</thead>
										<tbody>
						<?php foreach ($info as $info): ?>
											<tr>
												...
												<td style="text-align:right;max-width:100%;white-space:nowrap;"><?php echo htmlspecialchars($info['name']) ?></td>
											</tr>
						<?php endforeach ?>
										</tbody>
									</table>
