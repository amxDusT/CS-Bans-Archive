<?php
	...
	class SourceQuery
	{
		...
		public function GetPlayers( )
		{
			...
			$Buffer = $this->Socket->Read( 1400 ); // Moronic Arma 3 developers do not split their packets, so we have to read more data
			// This violates the protocol spec, and they probably should fix it: https://developer.valvesoftware.com/wiki/Server_queries#Protocol
			
			$Type = $Buffer->GetByte( );
			
			if( $Type !== self::S2A_PLAYER && $Type !== self::S2A_CHALLENGE )
			{
