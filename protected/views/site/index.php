...
<p><?php echo CHtml::encode(Yii::app()->name); ?> Installed.</p>

<?php $this->endWidget(); ?>

<div class="row-fluid">
	<div class="span6">
		<div class="alert alert-info"><h4>Last 10 Bans</h4></div>
		<?php
	...
	?>
	<div class="span6">
		<div class="alert alert-info"><h4>Server</h4></div>
	...
	<?php foreach($servers as $server):?>
		$.post(
			...
			function(data){
				...
				if(!info)
				{
					ret = '<td colspan="3"><?php echo $server['hostname']?> <b>Not Responding</b></td>';
					elem.addClass('error');
				}
				else
				{
